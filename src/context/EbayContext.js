...
import {ebayAbi,ebayCoinAddress} from '../lib/constants';
import { ethers } from 'ethers';

export const EbayContext = createContext();
...
export const EbayProvider = ({children}) => {
    ...
    ll().catch(console.error);
      ...
      const buyTokens = async () => {
        ...
        console.log(ebayCoinAddress)
    
        let options = {
          contractAddress: ebayCoinAddress,
          functionName: 'mint',
          abi: ebayAbi,
          msgValue: calcPrice,
          params: {
